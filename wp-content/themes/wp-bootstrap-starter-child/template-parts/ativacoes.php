...
?>
     <section class="pb-1 no-overflow ativacoes-aya">
      <div class="container">
        <div class="row gutter-1">
          <div class="col-md-6 col-lg-4 level-1">
            <div class="card card-equal bg-green text-white">
             
              <div class="card-footer p-4">
                <h2 class="card-title fs-30 w-75 mx-auto text-lowercase text-center text-blue">Ativações </h2>
              </div>
            </div>
          </div>
